...
```
    ...
    ## LDA_03         779.3669
    ## num_imgs        26.8119
    ## num_keywords   108.8550
    ##              t value Pr(>|t|)
    ## (Intercept)   -0.028 0.977299
    ## kw_avg_avg     3.074 0.002123
    ## kw_avg_min    -0.678 0.497561
    ## kw_min_avg     0.554 0.579402
    ## LDA_03         3.308 0.000945
    ## num_imgs       1.928 0.053864
    ## num_keywords   0.620 0.535023
    ##                 
    ## (Intercept)     
    ## kw_avg_avg   ** 
    ## kw_avg_min      
...
```
    ...
    ## kw_min_avg      0.21234
    ## num_imgs       26.58994
    ## num_keywords  108.95907
    ##              t value Pr(>|t|)
    ## (Intercept)   -0.394   0.6939
    ## kw_avg_avg     5.078 3.96e-07
    ## kw_avg_min    -1.298   0.1943
    ## kw_min_avg     0.360   0.7191
    ## num_imgs       2.397   0.0166
    ## num_keywords   0.621   0.5344
    ##                 
    ## (Intercept)     
    ## kw_avg_avg   ***
    ## kw_avg_min      
...
```
    ...
    ##                Estimate
    ## (Intercept)  -1.444e+00
    ## kw_avg_avg    3.331e-04
    ## kw_avg_min   -1.129e-04
    ## kw_min_avg    1.650e-05
    ## LDA_03       -4.034e-01
    ## num_imgs      1.551e-02
    ## num_keywords  6.062e-02
    ##              Std. Error
    ## (Intercept)   1.409e-01
    ## kw_avg_avg    3.974e-05
    ## kw_avg_min    7.898e-05
    ## kw_min_avg    3.252e-05
    ## LDA_03        1.194e-01
    ## num_imgs      4.026e-03
    ## num_keywords  1.589e-02
    ##              z value Pr(>|z|)
    ## (Intercept)  -10.248  < 2e-16
    ## kw_avg_avg     8.382  < 2e-16
    ## kw_avg_min    -1.430 0.152716
    ## kw_min_avg     0.507 0.611939
    ## LDA_03        -3.379 0.000728
    ## num_imgs       3.854 0.000116
    ## num_keywords   3.815 0.000136
    ##                 
    ## (Intercept)  ***
    ## kw_avg_avg   ***
    ## kw_avg_min      
...
```
    ...
    ##                Estimate
    ## (Intercept)  -1.417e+00
    ## kw_avg_avg    3.313e-04
    ## LDA_03       -3.859e-01
    ## num_imgs      1.583e-02
    ## num_keywords  5.471e-02
    ##              Std. Error
    ## (Intercept)   1.399e-01
    ## kw_avg_avg    3.206e-05
    ## LDA_03        1.166e-01
    ## num_imgs      4.021e-03
    ## num_keywords  1.483e-02
    ##              z value Pr(>|z|)
    ## (Intercept)  -10.125  < 2e-16
    ## kw_avg_avg    10.334  < 2e-16
    ## LDA_03        -3.309 0.000935
    ## num_imgs       3.936 8.29e-05
    ## num_keywords   3.690 0.000224
    ##                 
    ## (Intercept)  ***
    ## kw_avg_avg   ***
    ## LDA_03       ***
...
```
    ...
    ##                Estimate
    ## (Intercept)  -1.357e+00
    ## kw_avg_avg    2.643e-04
    ## kw_avg_min   -6.187e-05
    ## kw_min_avg    3.308e-05
    ## num_imgs      1.384e-02
    ## num_keywords  6.204e-02
    ##              Std. Error
    ## (Intercept)   1.376e-01
    ## kw_avg_avg    3.304e-05
    ## kw_avg_min    7.656e-05
    ## kw_min_avg    3.192e-05
    ## num_imgs      3.981e-03
    ## num_keywords  1.586e-02
    ##              z value Pr(>|z|)
    ## (Intercept)   -9.862  < 2e-16
    ## kw_avg_avg     8.001 1.24e-15
    ## kw_avg_min    -0.808 0.419016
    ## kw_min_avg     1.036 0.300083
    ## num_imgs       3.475 0.000511
    ## num_keywords   3.913 9.13e-05
    ##                 
    ## (Intercept)  ***
    ## kw_avg_avg   ***
    ## kw_avg_min      
...
```
    ...
    ##                Estimate
    ## (Intercept)  -1.351e+00
    ## kw_avg_avg    2.569e-04
    ## kw_min_avg    3.721e-05
    ## num_imgs      1.402e-02
    ## num_keywords  6.114e-02
    ##              Std. Error
    ## (Intercept)   1.375e-01
    ## kw_avg_avg    3.173e-05
    ## kw_min_avg    3.149e-05
    ## num_imgs      3.975e-03
    ## num_keywords  1.583e-02
    ##              z value Pr(>|z|)
    ## (Intercept)   -9.829  < 2e-16
    ## kw_avg_avg     8.095 5.72e-16
    ## kw_min_avg     1.182 0.237396
    ## num_imgs       3.528 0.000418
    ## num_keywords   3.863 0.000112
    ##                 
    ## (Intercept)  ***
    ## kw_avg_avg   ***
    ## kw_min_avg      
...
```
    ...
    ##              Estimate
    ## (Intercept)  -0.45294
    ## num_keywords  0.05997
    ##              Std. Error
    ## (Intercept)     0.10834
    ## num_keywords    0.01460
    ##              z value Pr(>|z|)
    ## (Intercept)   -4.181 2.91e-05
    ## num_keywords   4.106 4.03e-05
    ##                 
    ## (Intercept)  ***
    ## num_keywords ***
    ## ---
...
```
    ...
    ##           [,1]      [,2]
    ## [1,] 0.7687271 0.7737153
    ##           [,3]      [,4]
    ## [1,] 0.7589944 0.7605706
    ##          [,5]
    ## [1,] 0.707128
