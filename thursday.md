...
```
    ...
    ## LDA_03         460.1950
    ## num_imgs        14.5678
    ## num_keywords    63.0911
    ##              t value Pr(>|t|)
    ## (Intercept)   -1.100 0.271599
    ## kw_avg_avg     9.695  < 2e-16
    ## kw_avg_min     7.591 3.77e-14
    ## kw_min_avg    -3.859 0.000115
    ## LDA_03         0.256 0.798118
    ## num_imgs       3.113 0.001864
    ## num_keywords  -1.952 0.051026
    ##                 
    ## (Intercept)     
    ## kw_avg_avg   ***
    ## kw_avg_min   ***
...
```
    ...
    ## kw_min_avg       0.1264
    ## num_imgs        14.4324
    ## num_keywords    63.0491
    ##              t value Pr(>|t|)
    ## (Intercept)   -1.149   0.2505
    ## kw_avg_avg    11.287  < 2e-16
    ## kw_avg_min     7.702 1.60e-14
    ## kw_min_avg    -3.924 8.83e-05
    ## num_imgs       3.177   0.0015
    ## num_keywords  -1.962   0.0499
    ##                 
    ## (Intercept)     
    ## kw_avg_avg   ***
    ## kw_avg_min   ***
...
```
    ...
    ##               Estimate
    ## (Intercept) -1.633e+03
    ## kw_avg_avg   1.535e+00
    ##             Std. Error
    ## (Intercept)  3.236e+02
    ## kw_avg_avg   9.722e-02
    ##             t value Pr(>|t|)
    ## (Intercept)  -5.048 4.63e-07
    ## kw_avg_avg   15.788  < 2e-16
    ##                
    ## (Intercept) ***
    ## kw_avg_avg  ***
    ## ---
...
```
    ...
    ##                Estimate
    ## (Intercept)  -1.564e+00
    ## kw_avg_avg    3.622e-04
    ## kw_avg_min   -8.739e-05
    ## kw_min_avg    6.454e-05
    ## LDA_03       -2.531e-01
    ## num_imgs      1.093e-02
    ## num_keywords  5.831e-02
    ##              Std. Error
    ## (Intercept)   1.435e-01
    ## kw_avg_avg    4.115e-05
    ## kw_avg_min    7.586e-05
    ## kw_min_avg    3.296e-05
    ## LDA_03        1.192e-01
    ## num_imgs      3.798e-03
    ## num_keywords  1.603e-02
    ##              z value Pr(>|z|)
    ## (Intercept)  -10.902  < 2e-16
    ## kw_avg_avg     8.804  < 2e-16
    ## kw_avg_min    -1.152 0.249307
    ## kw_min_avg     1.958 0.050193
    ## LDA_03        -2.123 0.033758
    ## num_imgs       2.876 0.004023
    ## num_keywords   3.638 0.000275
    ##                 
    ## (Intercept)  ***
    ## kw_avg_avg   ***
    ## kw_avg_min      
...
```
    ...
    ##                Estimate
    ## (Intercept)  -1.5198703
    ## kw_avg_avg    0.0003954
    ## LDA_03       -0.2730188
    ## num_imgs      0.0113521
    ## num_keywords  0.0443769
    ##              Std. Error
    ## (Intercept)   0.1428015
    ## kw_avg_avg    0.0000338
    ## LDA_03        0.1169228
    ## num_imgs      0.0037909
    ## num_keywords  0.0148605
    ##              z value Pr(>|z|)
    ## (Intercept)  -10.643  < 2e-16
    ## kw_avg_avg    11.700  < 2e-16
    ## LDA_03        -2.335  0.01954
    ## num_imgs       2.995  0.00275
    ## num_keywords   2.986  0.00282
    ##                 
    ## (Intercept)  ***
    ## kw_avg_avg   ***
    ## LDA_03       *  
...
```
    ...
    ##                Estimate
    ## (Intercept)  -1.510e+00
    ## kw_avg_avg    3.173e-04
    ## kw_avg_min   -6.229e-05
    ## kw_min_avg    7.635e-05
    ## num_imgs      9.903e-03
    ## num_keywords  6.000e-02
    ##              Std. Error
    ## (Intercept)   1.407e-01
    ## kw_avg_avg    3.478e-05
    ## kw_avg_min    7.489e-05
    ## kw_min_avg    3.239e-05
    ## num_imgs      3.761e-03
    ## num_keywords  1.600e-02
    ##              z value Pr(>|z|)
    ## (Intercept)  -10.728  < 2e-16
    ## kw_avg_avg     9.122  < 2e-16
    ## kw_avg_min    -0.832 0.405541
    ## kw_min_avg     2.357 0.018427
    ## num_imgs       2.633 0.008462
    ## num_keywords   3.751 0.000176
    ##                 
    ## (Intercept)  ***
    ## kw_avg_avg   ***
    ## kw_avg_min      
...
```
    ...
    ##                Estimate
    ## (Intercept)  -1.504e+00
    ## kw_avg_avg    3.099e-04
    ## kw_min_avg    8.031e-05
    ## num_imgs      1.010e-02
    ## num_keywords  5.908e-02
    ##              Std. Error
    ## (Intercept)   1.407e-01
    ## kw_avg_avg    3.363e-05
    ## kw_min_avg    3.204e-05
    ## num_imgs      3.754e-03
    ## num_keywords  1.596e-02
    ##              z value Pr(>|z|)
    ## (Intercept)  -10.694  < 2e-16
    ## kw_avg_avg     9.216  < 2e-16
    ## kw_min_avg     2.507 0.012190
    ## num_imgs       2.691 0.007127
    ## num_keywords   3.702 0.000214
    ##                 
    ## (Intercept)  ***
    ## kw_avg_avg   ***
    ## kw_min_avg   *  
...
```
    ...
    ##              Estimate
    ## (Intercept)  -0.35730
    ## num_keywords  0.05085
    ##              Std. Error
    ## (Intercept)     0.10819
    ## num_keywords    0.01458
    ##              z value Pr(>|z|)
    ## (Intercept)   -3.302 0.000958
    ## num_keywords   3.487 0.000488
    ##                 
    ## (Intercept)  ***
    ## num_keywords ***
    ## ---
...
```
    ...
    ##           [,1]      [,2]
    ## [1,] 0.8276567 0.8364181
    ##           [,3]      [,4]
    ## [1,] 0.8153156 0.8133379
    ##           [,5]
    ## [1,] 0.7128586
