...
```
    ...
    ## LDA_03         585.0051
    ## num_imgs        18.4659
    ## num_keywords    83.5702
    ##              t value Pr(>|t|)
    ## (Intercept)   -2.753 0.005922
    ## kw_avg_avg     7.744 1.15e-14
    ## kw_avg_min    -3.347 0.000823
    ## kw_min_avg    -1.175 0.239927
    ## LDA_03         1.558 0.119397
    ## num_imgs       2.919 0.003530
    ## num_keywords   2.256 0.024138
    ##                 
    ## (Intercept)  ** 
    ## kw_avg_avg   ***
    ## kw_avg_min   ***
...
```
    ...
    ## kw_min_avg       0.1598
    ## num_imgs        18.3329
    ## num_keywords    83.5817
    ##              t value Pr(>|t|)
    ## (Intercept)   -2.957 0.003122
    ## kw_avg_avg     9.498  < 2e-16
    ## kw_avg_min    -3.695 0.000223
    ## kw_min_avg    -1.303 0.192667
    ## num_imgs       3.130 0.001760
    ## num_keywords   2.254 0.024224
    ##                 
    ## (Intercept)  ** 
    ## kw_avg_avg   ***
    ## kw_avg_min   ***
...
```
    ...
    ##                Estimate
    ## (Intercept)  -1.612e+00
    ## kw_avg_avg    4.232e-04
    ## kw_avg_min   -9.057e-06
    ## kw_min_avg   -3.251e-05
    ## LDA_03       -3.995e-01
    ## num_imgs      1.143e-02
    ## num_keywords  5.297e-02
    ##              Std. Error
    ## (Intercept)   1.447e-01
    ## kw_avg_avg    4.294e-05
    ## kw_avg_min    9.649e-05
    ## kw_min_avg    3.337e-05
    ## LDA_03        1.205e-01
    ## num_imgs      3.646e-03
    ## num_keywords  1.625e-02
    ##              z value Pr(>|z|)
    ## (Intercept)  -11.142  < 2e-16
    ## kw_avg_avg     9.855  < 2e-16
    ## kw_avg_min    -0.094 0.925214
    ## kw_min_avg    -0.974 0.330028
    ## LDA_03        -3.315 0.000915
    ## num_imgs       3.135 0.001716
    ## num_keywords   3.260 0.001113
    ##                 
    ## (Intercept)  ***
    ## kw_avg_avg   ***
    ## kw_avg_min      
...
```
    ...
    ##                Estimate
    ## (Intercept)  -1.620e+00
    ## kw_avg_avg    3.988e-04
    ## LDA_03       -3.763e-01
    ## num_imgs      1.134e-02
    ## num_keywords  5.853e-02
    ##              Std. Error
    ## (Intercept)   1.441e-01
    ## kw_avg_avg    3.375e-05
    ## LDA_03        1.169e-01
    ## num_imgs      3.642e-03
    ## num_keywords  1.509e-02
    ##              z value Pr(>|z|)
    ## (Intercept)  -11.243  < 2e-16
    ## kw_avg_avg    11.816  < 2e-16
    ## LDA_03        -3.220 0.001283
    ## num_imgs       3.114 0.001847
    ## num_keywords   3.879 0.000105
    ##                 
    ## (Intercept)  ***
    ## kw_avg_avg   ***
    ## LDA_03       ** 
...
```
    ...
    ##                Estimate
    ## (Intercept)  -1.514e+00
    ## kw_avg_avg    3.465e-04
    ## kw_avg_min    3.753e-05
    ## kw_min_avg   -1.026e-05
    ## num_imgs      1.014e-02
    ## num_keywords  5.539e-02
    ##              Std. Error
    ## (Intercept)   1.407e-01
    ## kw_avg_avg    3.519e-05
    ## kw_avg_min    9.423e-05
    ## kw_min_avg    3.245e-05
    ## num_imgs      3.610e-03
    ## num_keywords  1.620e-02
    ##              z value Pr(>|z|)
    ## (Intercept)  -10.759  < 2e-16
    ## kw_avg_avg     9.848  < 2e-16
    ## kw_avg_min     0.398 0.690448
    ## kw_min_avg    -0.316 0.751944
    ## num_imgs       2.808 0.004983
    ## num_keywords   3.419 0.000629
    ##                 
    ## (Intercept)  ***
    ## kw_avg_avg   ***
    ## kw_avg_min      
...
```
    ...
    ##                Estimate
    ## (Intercept)  -1.513e+00
    ## kw_avg_avg    3.493e-04
    ## kw_min_avg   -1.199e-05
    ## num_imgs      1.008e-02
    ## num_keywords  5.599e-02
    ##              Std. Error
    ## (Intercept)   1.406e-01
    ## kw_avg_avg    3.447e-05
    ## kw_min_avg    3.216e-05
    ## num_imgs      3.607e-03
    ## num_keywords  1.613e-02
    ##              z value Pr(>|z|)
    ## (Intercept)  -10.761  < 2e-16
    ## kw_avg_avg    10.133  < 2e-16
    ## kw_min_avg    -0.373 0.709184
    ## num_imgs       2.795 0.005182
    ## num_keywords   3.472 0.000517
    ##                 
    ## (Intercept)  ***
    ## kw_avg_avg   ***
    ## kw_min_avg      
...
```
    ...
    ##              Estimate
    ## (Intercept)  -0.46930
    ## num_keywords  0.06478
    ##              Std. Error
    ## (Intercept)     0.11002
    ## num_keywords    0.01480
    ##              z value Pr(>|z|)
    ## (Intercept)   -4.265  2.0e-05
    ## num_keywords   4.377  1.2e-05
    ##                 
    ## (Intercept)  ***
    ## num_keywords ***
    ## ---
...
```
    ...
    ##           [,1]      [,2]
    ## [1,] 0.8077438 0.8003514
    ##           [,3]      [,4]
    ## [1,] 0.7874139 0.7877065
    ##           [,5]
    ## [1,] 0.7045153
