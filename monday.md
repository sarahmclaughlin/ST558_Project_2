...
```
    ...
    ##                Estimate
    ## (Intercept)  -1.045e+03
    ## kw_avg_avg    1.198e+00
    ## kw_avg_min   -4.201e-01
    ## kw_min_avg   -5.443e-02
    ## LDA_03        9.240e+02
    ## num_imgs      1.197e+01
    ## num_keywords  1.228e+02
    ##              Std. Error
    ## (Intercept)   9.347e+02
    ## kw_avg_avg    2.279e-01
    ## kw_avg_min    3.523e-01
    ## kw_min_avg    2.199e-01
    ## LDA_03        7.813e+02
    ## num_imgs      2.505e+01
    ## num_keywords  1.125e+02
    ##              t value Pr(>|t|)
    ## (Intercept)   -1.118    0.263
    ## kw_avg_avg     5.254 1.55e-07
    ## kw_avg_min    -1.192    0.233
    ## kw_min_avg    -0.247    0.805
    ## LDA_03         1.183    0.237
    ## num_imgs       0.478    0.633
    ## num_keywords   1.092    0.275
    ##                 
    ## (Intercept)     
    ## kw_avg_avg   ***
    ## kw_avg_min      
...
```
    ...
    ##                Estimate
    ## (Intercept)  -1.136e+03
    ## kw_avg_avg    1.318e+00
    ## kw_avg_min   -5.191e-01
    ## kw_min_avg   -8.865e-02
    ## num_imgs      1.643e+01
    ## num_keywords  1.187e+02
    ##              Std. Error
    ## (Intercept)   9.316e+02
    ## kw_avg_avg    2.038e-01
    ## kw_avg_min    3.423e-01
    ## kw_min_avg    2.180e-01
    ## num_imgs      2.476e+01
    ## num_keywords  1.125e+02
    ##              t value Pr(>|t|)
    ## (Intercept)   -1.219    0.223
    ## kw_avg_avg     6.470 1.08e-10
    ## kw_avg_min    -1.517    0.129
    ## kw_min_avg    -0.407    0.684
    ## num_imgs       0.663    0.507
    ## num_keywords   1.056    0.291
    ##                 
    ## (Intercept)     
    ## kw_avg_avg   ***
    ## kw_avg_min      
...
```
    ...
    ## kw_avg_avg      0.1517
    ##             t value Pr(>|t|)
    ## (Intercept)  -0.079    0.937
    ## kw_avg_avg    7.762 1.02e-14
    ##                
    ## (Intercept)    
    ## kw_avg_avg  ***
    ## ---
...
```
    ...
    ##                Estimate
    ## (Intercept)  -1.518e+00
    ## kw_avg_avg    3.425e-04
    ## kw_avg_min   -1.066e-04
    ## kw_min_avg    2.861e-05
    ## LDA_03       -3.027e-01
    ## num_imgs      8.647e-03
    ## num_keywords  7.726e-02
    ##              Std. Error
    ## (Intercept)   1.489e-01
    ## kw_avg_avg    4.118e-05
    ## kw_avg_min    7.802e-05
    ## kw_min_avg    3.460e-05
    ## LDA_03        1.223e-01
    ## num_imgs      3.898e-03
    ## num_keywords  1.711e-02
    ##              z value Pr(>|z|)
    ## (Intercept)  -10.200  < 2e-16
    ## kw_avg_avg     8.317  < 2e-16
    ## kw_avg_min    -1.367   0.1717
    ## kw_min_avg     0.827   0.4083
    ## LDA_03        -2.475   0.0133
    ## num_imgs       2.218   0.0265
    ## num_keywords   4.517 6.28e-06
    ##                 
    ## (Intercept)  ***
    ## kw_avg_avg   ***
    ## kw_avg_min      
...
```
    ...
    ##                Estimate
    ## (Intercept)  -1.484e+00
    ## kw_avg_avg    3.485e-04
    ## LDA_03       -2.986e-01
    ## num_imgs      8.970e-03
    ## num_keywords  6.956e-02
    ##              Std. Error
    ## (Intercept)   1.476e-01
    ## kw_avg_avg    3.292e-05
    ## LDA_03        1.191e-01
    ## num_imgs      3.893e-03
    ## num_keywords  1.597e-02
    ##              z value Pr(>|z|)
    ## (Intercept)  -10.057  < 2e-16
    ## kw_avg_avg    10.586  < 2e-16
    ## LDA_03        -2.507   0.0122
    ## num_imgs       2.304   0.0212
    ## num_keywords   4.356 1.32e-05
    ##                 
    ## (Intercept)  ***
    ## kw_avg_avg   ***
    ## LDA_03       *  
...
```
    ...
    ##                Estimate
    ## (Intercept)  -1.468e+00
    ## kw_avg_avg    2.929e-04
    ## kw_avg_min   -7.320e-05
    ## kw_min_avg    4.464e-05
    ## num_imgs      7.294e-03
    ## num_keywords  7.907e-02
    ##              Std. Error
    ## (Intercept)   1.469e-01
    ## kw_avg_avg    3.540e-05
    ## kw_avg_min    7.666e-05
    ## kw_min_avg    3.389e-05
    ## num_imgs      3.852e-03
    ## num_keywords  1.708e-02
    ##              z value Pr(>|z|)
    ## (Intercept)   -9.994  < 2e-16
    ## kw_avg_avg     8.275  < 2e-16
    ## kw_avg_min    -0.955   0.3396
    ## kw_min_avg     1.317   0.1877
    ## num_imgs       1.894   0.0583
    ## num_keywords   4.630 3.66e-06
    ##                 
    ## (Intercept)  ***
    ## kw_avg_avg   ***
    ## kw_avg_min      
...
```
    ...
    ##                Estimate
    ## (Intercept)  -1.459e+00
    ## kw_avg_avg    2.836e-04
    ## kw_min_avg    4.900e-05
    ## num_imgs      7.444e-03
    ## num_keywords  7.803e-02
    ##              Std. Error
    ## (Intercept)   1.466e-01
    ## kw_avg_avg    3.401e-05
    ## kw_min_avg    3.358e-05
    ## num_imgs      3.849e-03
    ## num_keywords  1.705e-02
    ##              z value Pr(>|z|)
    ## (Intercept)   -9.952  < 2e-16
    ## kw_avg_avg     8.340  < 2e-16
    ## kw_min_avg     1.459   0.1444
    ## num_imgs       1.934   0.0531
    ## num_keywords   4.577 4.72e-06
    ##                 
    ## (Intercept)  ***
    ## kw_avg_avg   ***
    ## kw_min_avg      
...
```
    ...
    ##              Estimate
    ## (Intercept)  -0.50811
    ## num_keywords  0.07762
    ##              Std. Error
    ## (Intercept)     0.11578
    ## num_keywords    0.01566
    ##              z value Pr(>|z|)
    ## (Intercept)   -4.388 1.14e-05
    ## num_keywords   4.956 7.18e-07
    ##                 
    ## (Intercept)  ***
    ## num_keywords ***
    ## ---
...
```
    ...
    ##           [,1]      [,2]
    ## [1,] 0.7763334 0.8102003
    ##           [,3]      [,4]
    ## [1,] 0.7680279 0.7835722
    ##           [,5]
    ## [1,] 0.6876201
