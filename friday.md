...
```
    ...
    ## LDA_03         470.4473
    ## num_imgs        14.3999
    ## num_keywords    64.2359
    ##              t value Pr(>|t|)
    ## (Intercept)   -0.432   0.6658
    ## kw_avg_avg     5.240 1.69e-07
    ## kw_avg_min    -3.899 9.83e-05
    ## kw_min_avg    -1.344   0.1791
    ## LDA_03         2.240   0.0251
    ## num_imgs       2.217   0.0267
    ## num_keywords   2.231   0.0258
    ##                 
    ## (Intercept)     
    ## kw_avg_avg   ***
    ## kw_avg_min   ***
...
```
    ...
    ## kw_min_avg       0.1269
    ## num_imgs        14.3384
    ## num_keywords    64.2589
    ##              t value Pr(>|t|)
    ## (Intercept)   -0.784   0.4328
    ## kw_avg_avg     7.440 1.22e-13
    ## kw_avg_min    -5.076 4.03e-07
    ## kw_min_avg    -1.638   0.1014
    ## num_imgs       2.446   0.0145
    ## num_keywords   2.191   0.0285
    ##                 
    ## (Intercept)     
    ## kw_avg_avg   ***
    ## kw_avg_min   ***
...
```
    ...
    ##              Estimate
    ## (Intercept) 1.393e+03
    ## kw_avg_avg  5.596e-01
    ##             Std. Error
    ## (Intercept)  2.875e+02
    ## kw_avg_avg   8.406e-02
    ##             t value Pr(>|t|)
    ## (Intercept)   4.846 1.31e-06
    ## kw_avg_avg    6.657 3.18e-11
    ##                
    ## (Intercept) ***
    ## kw_avg_avg  ***
    ## ---
...
```
    ...
    ##                Estimate
    ## (Intercept)  -9.563e-01
    ## kw_avg_avg    2.990e-04
    ## kw_avg_min   -2.385e-04
    ## kw_min_avg   -1.547e-05
    ## LDA_03       -5.634e-02
    ## num_imgs      9.134e-03
    ## num_keywords  3.744e-02
    ##              Std. Error
    ## (Intercept)   1.617e-01
    ## kw_avg_avg    4.630e-05
    ## kw_avg_min    5.200e-05
    ## kw_min_avg    3.713e-05
    ## LDA_03        1.354e-01
    ## num_imgs      4.191e-03
    ## num_keywords  1.794e-02
    ##              z value Pr(>|z|)
    ## (Intercept)   -5.914 3.35e-09
    ## kw_avg_avg     6.458 1.06e-10
    ## kw_avg_min    -4.587 4.50e-06
    ## kw_min_avg    -0.417   0.6769
    ## LDA_03        -0.416   0.6774
    ## num_imgs       2.180   0.0293
    ## num_keywords   2.087   0.0369
    ##                 
    ## (Intercept)  ***
    ## kw_avg_avg   ***
    ## kw_avg_min   ***
...
```
    ...
    ##                Estimate
    ## (Intercept)  -8.199e-01
    ## kw_avg_avg    2.216e-04
    ## LDA_03        7.803e-02
    ## num_imgs      1.040e-02
    ## num_keywords  3.432e-02
    ##              Std. Error
    ## (Intercept)   1.598e-01
    ## kw_avg_avg    3.645e-05
    ## LDA_03        1.312e-01
    ## num_imgs      4.188e-03
    ## num_keywords  1.704e-02
    ##              z value Pr(>|z|)
    ## (Intercept)   -5.130  2.9e-07
    ## kw_avg_avg     6.080  1.2e-09
    ## LDA_03         0.595    0.552
    ## num_imgs       2.483    0.013
    ## num_keywords   2.015    0.044
    ##                 
    ## (Intercept)  ***
    ## kw_avg_avg   ***
    ## LDA_03          
...
```
    ...
    ##                Estimate
    ## (Intercept)  -9.437e-01
    ## kw_avg_avg    2.887e-04
    ## kw_avg_min   -2.301e-04
    ## kw_min_avg   -1.274e-05
    ## num_imgs      8.989e-03
    ## num_keywords  3.769e-02
    ##              Std. Error
    ## (Intercept)   1.587e-01
    ## kw_avg_avg    3.891e-05
    ## kw_avg_min    4.777e-05
    ## kw_min_avg    3.652e-05
    ## num_imgs      4.175e-03
    ## num_keywords  1.793e-02
    ##              z value Pr(>|z|)
    ## (Intercept)   -5.945 2.77e-09
    ## kw_avg_avg     7.420 1.18e-13
    ## kw_avg_min    -4.818 1.45e-06
    ## kw_min_avg    -0.349   0.7271
    ## num_imgs       2.153   0.0313
    ## num_keywords   2.103   0.0355
    ##                 
    ## (Intercept)  ***
    ## kw_avg_avg   ***
    ## kw_avg_min   ***
...
```
    ...
    ##                Estimate
    ## (Intercept)  -8.521e-01
    ## kw_avg_avg    2.198e-04
    ## kw_min_avg    2.424e-05
    ## num_imgs      1.062e-02
    ## num_keywords  3.817e-02
    ##              Std. Error
    ## (Intercept)   1.582e-01
    ## kw_avg_avg    3.656e-05
    ## kw_min_avg    3.572e-05
    ## num_imgs      4.171e-03
    ## num_keywords  1.797e-02
    ##              z value Pr(>|z|)
    ## (Intercept)   -5.386 7.21e-08
    ## kw_avg_avg     6.012 1.83e-09
    ## kw_min_avg     0.679   0.4975
    ## num_imgs       2.546   0.0109
    ## num_keywords   2.124   0.0337
    ##                 
    ## (Intercept)  ***
    ## kw_avg_avg   ***
    ## kw_min_avg      
...
```
    ...
    ##              Estimate
    ## (Intercept)  -0.10392
    ## num_keywords  0.03860
    ##              Std. Error
    ## (Intercept)     0.12540
    ## num_keywords    0.01687
    ##              z value Pr(>|z|)
    ## (Intercept)   -0.829   0.4072
    ## num_keywords   2.288   0.0221
    ##               
    ## (Intercept)   
    ## num_keywords *
    ## ---
...
```
    ...
    ##           [,1]      [,2]
    ## [1,] 0.7060669 0.6677653
    ##          [,3]      [,4]
    ## [1,] 0.702731 0.6670185
    ##           [,5]
    ## [1,] 0.6267011
